...
public class SearchFunctionalityTest extends BaseTest {
    ...
    public void verifySearchForExistingProduct() {
        ...
        Assert.assertTrue(searchResultPage.hasResults(), "There are no products for this search criteria.");
    }
    ...
    public void verifySearchForNonExistingProductShowsNoResultMessage() {
        ...
        Assert.assertTrue(searchResultPage.hasNoResult(), "Products were found for a non-existing search criteria.");
    }
    ...
    public void verifySearchUsingPartialKeywordReturnsMatchingProducts() {
        ...
        Assert.assertTrue(searchResultPage.hasResults(), "Expected search results, but no products were found.");
        Assert.assertTrue(searchResultPage.allProductsContain("mac"), "Some search results do not match the search keyword.");
    }
    @Test
    public void verifySearchWithSpecialCharacterShowsNoResult() {
        SearchResultPage searchResultPage = homePage.searchFor("!@#$%!^");
        Assert.assertTrue(searchResultPage.hasNoResult(), "Products were found when searching with special characters.");
    }
